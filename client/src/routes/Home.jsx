    ...
    <>
      ...
      <div className='mx-auto md:max-w-[1400px] w-full h-auto flex flex-col justify-center items-center md:p-4'>
            <div className='md:w-1/2 w-[90%] h-[20%] md:flex md:justify-center md:items-center md:flex-row flex flex-col justify-center items-center text-white p-2'>
              ...
              <button className='p-3 md:w-[30%] w-full justify-center bg-[#2a9d8f] rounded hover:bg-[#238176] ease-in-out duration-300 m-1 flex items-center'><AiOutlineSearch size={18} />Rechercher</button>
            </div>
            {Movies.length >= 1 ?
            <div className='flex'>
            ...
            <div className='flex flex-wrap justify-center animate__animated animate__fadeIn'>
              ...
              Movies.map((movie, key) => (
                <div key={key} className='max-w-sm rounded overflow-hidden m-3 flex flex-col justify-center items-center cursor-pointer'>
                  <img src={movie.poster_path == null ? 'https://via.placeholder.com/300x450' : `https://image.tmdb.org/t/p/w300/${movie.poster_path}`} alt="Sunset in the mountains" className=' ease-in-out duration-300 bg-[#b81e13]'/>
